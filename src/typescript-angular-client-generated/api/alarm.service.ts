...
export class AlarmService {
    ...
    public createContactList(searchFilter: AlarmQueryObject, observe: any = 'body', reportProgress = false ): Observable<any> {
        ...
        return this.httpClient.post<ContactList>(`${this.basePath}/alarm`,
            searchFilter,
            {
